...
class DashboardViewController: UIViewController {
    ...
    */
    func updateAccounts(index: Int) {
        ...
        totalAccountAmountLabel.attributedText = Utils.getPriceAttributedString(LocalizationUtils.localizeCurrency(totalAccountAmount), dollarSize: 38, centSize: 23, color: totalAccountAmountLabel.textColor)
...
extension DashboardViewController: UITableViewDataSource {
    ...
    */
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.amountLabel.attributedText = Utils.getPriceAttributedString(LocalizationUtils.localizeCurrency(account.balance.toDouble), dollarSize: 38, centSize: 23, color: UIColor.darkGrayTextHatch())
