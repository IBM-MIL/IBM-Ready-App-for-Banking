...
extension NSDate {
    ...
    // MARK: Components
    private class func componentFlags() -> NSCalendarUnit { return .CalendarUnitYear | .CalendarUnitMonth | .CalendarUnitDay | .CalendarUnitWeekOfYear | .CalendarUnitHour | .CalendarUnitMinute | .CalendarUnitSecond | .CalendarUnitWeekday | .CalendarUnitWeekdayOrdinal }
